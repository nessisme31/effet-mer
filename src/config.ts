...
export const CONFIG = {
  ...
  location: "Plage Banyan Tree - Tamouda Bay",
  currency: "DH",
  ...
  activities: [
    ...
    { id: "jet-fx-30",  name: "Jet Ski FX", duration: "30 min", durationMinutes: 30,  price: 1200, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-60",  name: "Jet Ski FX", duration: "1h00",  durationMinutes: 60,  price: 2000, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-90",  name: "Jet Ski FX", duration: "1h30",  durationMinutes: 90,  price: 3200, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-120", name: "Jet Ski FX", duration: "2h00",  durationMinutes: 120, price: 4000, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-150", name: "Jet Ski FX", duration: "2h30",  durationMinutes: 150, price: 5200, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-180", name: "Jet Ski FX", duration: "3h00",  durationMinutes: 180, price: 6000, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-210", name: "Jet Ski FX", duration: "3h30",  durationMinutes: 210, price: 7200, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "jet-fx-240", name: "Jet Ski FX", duration: "4h00",  durationMinutes: 240, price: 8000, requiresJetSki: true, jetType: "FX" as const, image: "/activities/jetski_FX.webp" },
    { id: "bouee-15",   name: "Bouée Tractée", duration: "15 min", durationMinutes: 15, price: 300, requiresJetSki: false, hasSubtype: true, image: "/activities/Bouee_tractee.webp" },
    { id: "ski-15",     name: "Ski Nautique",  duration: "15 min", durationMinutes: 15, price: 450, requiresJetSki: false, image: "/activities/Ski_Nautique.webp" },
    { id: "ski-30",     name: "Ski Nautique",  duration: "30 min", durationMinutes: 30, price: 800, requiresJetSki: false, image: "/activities/Ski_Nautique.webp" },
    { id: "wake-15",    name: "Wakeboard",     duration: "15 min", durationMinutes: 15, price: 450, requiresJetSki: false, image: "/activities/Wakeboard.webp" },
    { id: "wake-30",    name: "Wakeboard",     duration: "30 min", durationMinutes: 30, price: 800, requiresJetSki: false, image: "/activities/Wakeboard.webp" },
    { id: "paddle-1h",  name: "Paddle",        duration: "1h00",   durationMinutes: 60,  price: 200, requiresJetSki: false, image: "/activities/paddle.webp" },
    { id: "paddle-2h",  name: "Paddle",        duration: "2h00",   durationMinutes: 120, price: 300, requiresJetSki: false, image: "/activities/paddle.webp" },
    { id: "kayak-1h",   name: "Kayak",         duration: "1h00",   durationMinutes: 60,  price: 200, requiresJetSki: false, image: "/activities/Kayak.webp" },
    { id: "kayak-2h",   name: "Kayak",         duration: "2h00",   durationMinutes: 120, price: 300, requiresJetSki: false, image: "/activities/Kayak.webp" },
    { id: "scooter-20", name: "Scooter sous-marin", duration: "20 min", durationMinutes: 20, price: 350, requiresJetSki: false, image: "/activities/Scootersousmarin.webp" },
    { id: "scooter-40", name: "Scooter sous-marin", duration: "40 min", durationMinutes: 40, price: 600, requiresJetSki: false, image: "/activities/Scootersousmarin.webp" },
  ] as ActivityConfig[],

  // Images des sous-types de bouées
  boueeSubtypeImages: {
    'Bouée':      '/activities/bouee.webp',
    'Banane':     '/activities/banane.webp',
    'Air Stream': '/activities/AirStream.webp',
    'Canapé':     '/activities/Canape.webp',
